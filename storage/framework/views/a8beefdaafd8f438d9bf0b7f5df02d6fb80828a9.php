            ...
            <li class="nav-item menu-items">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="/dishesadd">Dishes</a></li>
                        <li class="nav-item"> <a class="nav-link" href="/dishescatagoryadd">Dishes Catagory</a></li>
                        <li class="nav-item"> <a class="nav-link" href="/dishessubcatagoryadd">Dishes SubCatagory</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item menu-items">
                ...
                <div class="collapse" id="auth">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="/table"> Table Details </a></li>
                        <li class="nav-item"> <a class="nav-link" href="#"> Booked Tables</a></li>
...
<?php /**PATH C:\Users\Mangesh Mylvahanan\Laravel\Task 10-7-23\Restaurant\resources\views/Admin/header.blade.php ENDPATH**/ ?>