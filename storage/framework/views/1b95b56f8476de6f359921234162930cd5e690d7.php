            ...
            <div class="d-flex justify-content-center" style="width: 600px;height:300px;background-color: rgb(119, 119, 204);left:200px;">
                <form action="/updatecatagory" method="POST">
                    <div class="col-md">
                        ...
                        <input type="time" name="fromtime" class="form-control" value=<?php echo e($catagory->fromtime); ?> id="validationCustom01">
                        <span style="display: none" id="producterror"></span>
                    </div>
                    <div class="col-md">
                        <label for="validationCustom02" class="form-label text-light">To Time</label>
                        <input type="time" name="totime" value=<?php echo e($catagory->totime); ?> class="form-control" id="validationCustom02">
                        <span style="display: none" id="producterror"></span>
                    </div>
                    <br>
                    ...
                    <input type="hidden" name="cat_id" value="<?php echo e($catagory->id); ?>">
...
<?php echo $__env->make('Admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mangesh Mylvahanan\Laravel\Task 10-7-23\Restaurant\resources\views/Catagory/updatecatagory.blade.php ENDPATH**/ ?>