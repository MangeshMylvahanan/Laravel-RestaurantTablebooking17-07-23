...
<body>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4">
                                <img class="img-fluid" src="<?php echo e(asset('chef/' .$data['chef_image'])); ?>" alt="">
                            </div>
                            <h5 class="mb-0"><?php echo e($data['chef']); ?></h5>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p><?php echo e($catagory['fromtime']); ?>-<?php echo e($catagory['totime']); ?></p>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="col-lg-3 col-md-6">
 ...
 <?php /**PATH C:\Users\Mangesh Mylvahanan\Laravel\Task 10-7-23\Restaurant\resources\views/User/homepage.blade.php ENDPATH**/ ?>