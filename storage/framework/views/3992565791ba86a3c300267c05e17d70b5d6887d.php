            ...
            <div class="row">
                <form enctype="multipart/form-data" action="/adddish" method="POST">
                    <div class="col-md-">
                        ...
                        <input type="text" name="name" class="form-control" id="validationCustom01" value=<?php echo e($dishes->name); ?>>
                        <span style="display: none" id="producterror"></span>
                    </div>
                    <div class="col-md-">
                        <label for="validationCustom02" class="form-label text-light">Price</label>
                        <input type="text" name="price" class="form-control" id="actualpriceid" value=<?php echo e($dishes->price); ?> required>
                    ...
                    <div class="col-md-">
                        ...
                        <textarea style="height: 100px" type="text" name="description" value=<?php echo e($dishes->description); ?> class="form-control" id="validationCustom05" required></textarea>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-">
                        ...
                        <input type="text" name="chef" class="form-control" value=<?php echo e($dishes->chef); ?>
...
<?php echo $__env->make('Admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mangesh Mylvahanan\Laravel\Task 10-7-23\Restaurant\resources\views/Dish/update.blade.php ENDPATH**/ ?>