...
<head>
    ...
    <link
        href="{{ asset('assets/https://fonts.googleapis.com/css2?family=Heebo:wght@400;500;600&family=Nunito:wght@600;700;800&family=Pacifico&display=swap') }}"
        rel="stylesheet">
    ...
    <div class="container-xxl bg-white p-0">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Master Chefs</h5>
                                <p>Ever You taste the food like here..our chefs are international standard..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Quality Food</h5>
                                <p>Hygenic,clean and neat is our daily goal..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Online Order</h5>
                                <p>Fresh to home...30 mins delivery...</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">International style foods..we also provide events management..</p>
                        <p class="mb-4">Book a table..We serve food with Love..</p>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Available Dishes</h1>
                </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="{{ asset('uploads/' . $item['image']) }}" alt="" style="width: 80px;">
        ...
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="video">
                        <button type="button" class="btn-play" data-bs-toggle="modal" data-src="https://youtube.com/shorts/KaUvfsAhIaA?feature=share" data-bs-target="#videoModal">
                            <span></span>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4">
                                <img class="img-fluid" src="{{ asset('chef/' .$data['chef_image']) }}" alt="">
                            </div>
                            <h5 class="mb-0">{{ $data['chef'] }}</h5>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p>{{ $catagory['fromtime'] }}-{{ $catagory['totime'] }}</p>
                        @endforeach
                    </div>
                    <div class="col-lg-3 col-md-6">
